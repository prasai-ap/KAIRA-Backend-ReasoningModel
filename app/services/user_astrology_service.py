...
from app.utils.astrology_helpers import jd_from_birth, set_ayanamsa_mode_safe, place_to_obj, place_to_tuple, normalize_timezone
    ...
    return {
        "meta": {
            ...
            "place": {
                ...
                "normalized_timezone": normalize_timezone(place_tuple[3]),
            },
            "birth": {
